...
* The original package name 'org.groopy.chat-service' is invalid and this project uses 'org.groopy.chatservice' instead.
...
* [New Relic](https://docs.spring.io/spring-boot/docs/2.7.2/reference/htmlsingle/#actuator.metrics.export.newrelic)
